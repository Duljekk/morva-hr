  ...
  const attendanceGroups = [
    {
      ...
      isToday: true,
      activities: [
        { id: 't1', type: 'check-in' as const, time: '11:00', status: 'On Time' as const },
        { id: 't2', type: 'check-out' as const, time: '19:20', status: 'Overtime' as const },
      ],
    },
    {
      id: 'yesterday',
      ...
      isYesterday: true,
      activities: [
        { id: 'y1', type: 'check-in' as const, time: '11:12', status: 'Late' as const },
        { id: 'y2', type: 'check-out' as const, time: '19:00', status: 'On Time' as const },
      ],
    },
    {
      id: 'dec6',
      label: 'December 6',
      activities: [
        { id: 'd1', type: 'check-in' as const, time: '11:00', status: 'On Time' as const },
        { id: 'd2', type: 'check-out' as const, time: '19:00', status: 'On Time' as const },
      ],
    },
  ];

  const leaveRequestGroups = [
    {
      id: 'pending',
      label: 'Pending Requests',
      activities: [
        { id: 'l1', type: 'check-in' as const, time: 'Dec 15-17', status: undefined },
      ],
    },
  ];
