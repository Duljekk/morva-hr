...
const sizeStyles = {
  sm: {
    ...
    text: 'text-sm font-medium leading-4 tracking-[-0.07px] h-4', // 14px text, medium weight, 16px line height, 16px height
    iconSize: 'h-3.5 w-3.5', // 14px
    gap: 'gap-1', // 4px gap between icon and text
  },
  md: {
    container: 'px-2 py-0.5 rounded-lg',
    text: 'text-sm font-normal leading-5 tracking-[-0.07px]',
    iconSize: 'h-3.5 w-3.5', // 14px
    gap: 'gap-1', // 4px gap
  },
};
