...
export interface PayslipIconProps extends React.SVGProps<SVGSVGElement> {
  /**
...
/**
 * Payslip Icon Component for Employee Floating Navbar
 *
 * A receipt/bill icon used in the employee floating navigation bar.
 * Supports active/inactive states for navigation highlighting.
 *
 * @example
 * ```tsx
 * <PayslipIcon active={true} size={24} />
 * <PayslipIcon active={false} size={24} />
 * ```
 */
const PayslipIcon = memo(function PayslipIcon({
  size = 24,
  active = false,
  className = '',
  ...props
...
PayslipIcon.displayName = 'PayslipIcon';
