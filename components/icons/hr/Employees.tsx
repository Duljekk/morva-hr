...
export interface EmployeesIconProps extends React.SVGProps<SVGSVGElement> {
  /**
...
/**
 * Employees Icon Component
 * 
 * A users/people icon representing employee management and team members.
 * 
 * @example
 * ```tsx
 * <EmployeesIcon className="w-4 h-4 text-neutral-600" />
 * ```
 */
