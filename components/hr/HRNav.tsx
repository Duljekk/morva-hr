...
import { hrRoutes, isRouteActive, type RouteConfig } from '@/lib/navigation/routes';
 ...
 * Displays navigation links for HR admin routes
 * 
 * Features:
 ...
 */
export default function HRNav({ currentPath }: HRNavProps) {
